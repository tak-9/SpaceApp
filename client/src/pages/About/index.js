        ...
        <div>
            ...
            <section className="py-5">
                <div className="container">
                    ...
                    <p>
                    We have been asked to maintain social distancing and stay at home to protect everyone from COVID-19. While it's beneficial in limiting the spread of the COVID-19 virus, isolation for an extended period of time has its detrimental impact on mental and physical health. To combat the effects on mental health, the iSolution team has worked to create a solution using tips from NASA astronauts as a reference.
                </p>
                <p>
                    NASA astronauts share expert advice on about their training and the concept of expeditionary skills for life.
                </p>
                <p>
                ...
                <p>
                    NASA astronaut Anne McClain suggests the following <a target="blank" href="https://www.nasa.gov/feature/an-astronaut-s-tips-for-living-in-space-or-anywhere">five good expeditionary behavior skills</a>:
                </p>
                <p>
                ♡ Communication
                </p>
                ...
                <p>
                    iSolution focuses on Self-Care for social isolation issues caused by COVID-19.
                </p>
                <p>
                    Self-Care means keeping track of how healthy you are on psychological and physical levels. It includes hygiene, managing your time, activities and responsibilities, getting sleep, and maintaining your mood. iSolution provides a day management tool that allows users to easily create a task list and pulling it into a daily calendar for easy time management and scheduling important self-care activities. Through self-care, you demonstrate your ability to be proactive in staying healthy.
                ...
                <p>
                    NASA offers information on Self-Care in the <a href="https://www.nasa.gov/audience/foreducators/stem-on-station/expeditionary-skills-for-life.html">Expeditionary Skills for Life</a> section on their NASA STEM website.  There are tools available for people to learn how to plan their time, including setting SMART goals, creating a daily schedule and prioritising tasks and self-care activities, and managing stress. It is paramount for everyone to learn how to manage our day in a productive and loving manner, and iSolution is here to do that with you.</p>
